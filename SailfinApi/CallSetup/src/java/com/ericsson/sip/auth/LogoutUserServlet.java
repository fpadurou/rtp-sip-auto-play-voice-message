...
public class LogoutUserServlet extends HttpServlet 
{
    ...
    throws ServletException, IOException 
	{
		...
		if(strSession == null || strSession.length != 1)
		{
		...
		{
			// --- log out user
			result = SqlManager.logoutUser(strSession[0]);
		}
		catch(Exception e)
		{
			// TODO: close it with error treatment
			logger.log(Level.SEVERE, "Voice: Logout error: " + e);
		}
    ...
    {
		logger.log(Level.INFO, "Started LogoutUserServlet.");
    }
}
